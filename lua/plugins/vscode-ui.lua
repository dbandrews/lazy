...
return {
  ...
  -- ╰────────────────────────────────────────────────────────╯
  {
    "folke/snacks.nvim",
    opts = {
      -- Put the cheatsheet on the start screen: it is the one thing a new user
      -- of this config has no way to guess at.
      dashboard = {
        preset = {
          keys = {
            ...
            { icon = "󰌌 ", key = "k", desc = "Keyboard Shortcuts", action = ":Cheatsheet" },
            {
              icon = " ",
              key = "c",
              desc = "Config",
